                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control col-sm-9" name="no_plat" placeholder="Isi Tipe">
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3">Lapangan</label>
                                <input type="text" class="form-control col-sm-9" name="merk" placeholder="Isi Lapangan">
                            </div>
